package com.wenyi.optionview.lib;
...
import com.wenyi.optionview.R;
import com.wenyi.optionview.adapter.WheelAdapter;
import com.wenyi.optionview.listener.OnItemSelectedListener;
import com.wenyi.optionview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    private static final float CENTERCONTENTOFFSET = 4.5F;//中间文字文字居中需要此偏移值
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getColor(R.color.pickerview_wheelview_textcolor_out);
        textColorCenter = getColor(R.color.pickerview_wheelview_textcolor_center);
        dividerColor = getColor(R.color.pickerview_wheelview_textcolor_divider);
