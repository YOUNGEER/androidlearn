...
import com.wenyi.banner.adapter.BannerPageAdapter;
import com.wenyi.banner.adapter.BaseBannerAdapter;
import com.wenyi.banner.listen.OnItemClickListener;
import com.wenyi.banner.view.BannerLoopViewPager;
...
public class Banner<T> extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public Banner setAdapter(BaseBannerAdapter holderCreator, List<T> datas){
        ...
        if(pageAdapter!=null)return this;
    ...
    private void initDefaultIndicator() {
        ...
        if(loPageTurningPoint==null){
            ...
            params.setMargins(dpToPx(5),dpToPx(10),dpToPx(5),dpToPx(10));
