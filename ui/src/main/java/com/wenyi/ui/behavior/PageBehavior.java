...
public class PageBehavior extends CoordinatorLayout.Behavior {
    ...
    private float gap;
    private OnShowNextPageListener mListen;

    public PageBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        scroller = new Scroller(context);
        handler = new Handler();
        gap = MyViewUtil.dip2px(120);
    }
    ...
    public void setPageListen(OnShowNextPageListener listen){
        mListen = listen;
    }
