package com.wenyi.selectimg.adapter;
...
import com.wenyi.selectimg.ImageInfo;
import com.wenyi.selectimg.PhotoPickActivity;
...
//    }
    ...
    public GridPhotoAdapter(Context context, Cursor c, boolean autoRequery, PhotoPickActivity activity) {
        ...
        itemWidth = (context.getResources().getDisplayMetrics().widthPixels- spacePix * 4) / 3;
    }
...
//
        ...
        Util.displayImage(context,path, holder.icon);
