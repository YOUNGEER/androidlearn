...
import com.wenyi.tab.listener.OnTabSelectListener;
import com.wenyi.tab.utils.UnreadMsgUtils;
import com.wenyi.tab.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        if (mTabSpaceEqual || mTabWidth > 0)
            mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, dp2px(0));
        else mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, dp2px(20));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            else lp.leftMargin = (int) (mTabPadding + textWidth + dp2px(leftPadding));
            if (mHeight > 0) lp.topMargin = (int) (mHeight - textHeight) / 2 - dp2px(bottomPadding);
            else lp.topMargin = 0;
