...
import com.wenyi.tab.utils.FragmentChangeManager;
...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        if (mTabSpaceEqual || mTabWidth > 0)
            mTabPadding = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_padding, dp2px(0));
        else mTabPadding = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_padding, dp2px(10));
